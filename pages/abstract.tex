...
\begin{cnabstract}{预期共识效应；资产定价；智能体；深度学习}
...
为此，本文基于多智能体实验金融框架，构建了异质性的智能体投资者模型：
以A股市场88个公司特征因子作为模型输入，
采用多层感知机作为智能体的决策框架，通过近端策略优化强化学习算法完成智能体训练，
...
通过融资融券标的分组检验与多智能体反事实模拟实验发现，融资融券约束是预期共识定价效应的重要形成机制，
